...
class DiFF_TreeEnsemble:
    ...
    - __predict__
    '''
    def __init__(self, sample_size: int = 32, n_trees: int = 512):
        '''
    ...
    def decision_function(self, alpha = 0.1):
        """
        Obtain different anomoly scores of the dataset 
        
        sc_ff: frequency of visit scoring only
        sc_di: point-wise anomaly score
        sc_diff_rf: collective anomaly score
        ...
        -------
            the object itself.
        """        
        sc_di,sc_ff,sc_diff_rf = diff_Tree.anomaly_score(X_train,alpha=alpha)
